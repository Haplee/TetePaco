...
if defined FILE_EXT_LOW (
    :: Usar PowerShell para convertir la extensión a minúsculas de forma fiable
    for /f "delims=" %%L in ('powershell -nologo -noprofile -command "'!FILE_EXT!'.ToLower()"') do set "FILE_EXT_LOW=%%L"
)
